...
- Endre startfarten til ballen slik at den ikke bare har fart i y-retning
  (nedover), men også x-retning (høyre/venstre) 
- Legg til støtte for at ballen kan sprette av veggene.
- Legg til funksjonalitet som fjerner ballen når den har stoppet å sprette.
- Lag 10 baller!. Her kan dere bruke arrays for å lagre ballene. 
- EKSTRA: Få ballene til å sprette tilbake når de kolliderer med
 hverandre. Denne er litt vanskelig, men med god kontroll på litt fysikk bør det
 gå greit! 


Det er mange gode ressurser på p5js.org/reference/ om dere sitter litt fast med 
p5-koden. 
*/
